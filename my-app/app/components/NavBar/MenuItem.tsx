...
const MenuItem: React.FC<MenuItemProps> = ({ onClick, label, icon }) => {
  return (
    <li
      className="px-4 flex hover:text-amber-300 group flex-row py-3 border border-neutral-200 hover:border-neutral-700 rounded cursor-pointer transition font-bold"
      onClick={onClick}
    >
